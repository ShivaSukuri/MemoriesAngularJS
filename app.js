...
app.controller("MemoryController",['$scope','$filter',function($scope,$filter){
    ...
    // $scope.handleDrop = function(event, index, item) {
    //     // Logic to handle the drop, if needed
    // };
    ...
    $scope.submitForm=function(){
        // const todayDate=new Date($scope.currentDate);
        // console.log(todayDate);


        if($scope.inputMemory.title==='' || $scope.inputMemory.currentDate==='' || $scope.inputMemory.description===''){
